  ...
  const filterContent = (content: Content[]) => {
    ...
    if (searchQuery) {
      ...
      filtered = filtered.filter(
        item => item.nome.toLowerCase().includes(query) || 
    ...
    <div className="min-h-screen bg-netflix-black">
      ...
      <div className="px-4 md:px-10 pt-4 md:pt-8 flex flex-col sm:flex-row gap-4 items-center">
        ...
        <div className="flex gap-2 items-center">
          ...
          <select 
            className="bg-netflix-dark text-netflix-white border border-netflix-gray rounded px-2 py-1 text-sm"
            value={sortBy}
            onChange={(e) => setSortBy(e.target.value as "nome" | "nota" | "ano" | "plataforma")}
          >
        ...
        <div className="flex gap-2">
          <Button 
            ...
            className={viewMode === 'grid' ? "bg-netflix-red" : "border-netflix-gray text-netflix-white"}
            size="sm"
          >
            Grade
          </Button>
          <Button 
            ...
            className={viewMode === 'list' ? "bg-netflix-red" : "border-netflix-gray text-netflix-white"}
            size="sm"
          >
            Lista
          </Button>
      ...
      {/* Content */}
      <div className="mt-4 md:mt-8 pb-16 px-4 md:px-10">
        {isLoading ? (
